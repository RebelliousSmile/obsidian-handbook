...
const work = mkdtempSync(join(tmpdir(), "handbook-pbta-specialized-"));
...
try {
	buildSync({ entryPoints: ["tools/pbtaSpecializedProjection.harness.mts"], outfile: bundle, bundle: true, platform: "node", format: "esm", target: "node16", alias: { obsidian: stub }, external: ["fs", "path"], logLevel: "warning" });

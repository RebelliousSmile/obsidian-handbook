...
const content: Record<string, string> = {
	...
	"handbook/test/pack.json": JSON.stringify({ manifestVersion: 1, version: "1.0.0", minimumHandbookVersion: "2.7.0", requires: [], pack: { id: "test", label: "Test", style: {}, assets: { images: { paper: "paper.png" } } } }),
};
...
if (!files.has(`${root}/packs/test/pack.json`) || !files.has(`${root}/packs/test/assets/paper.png`) || !files.has(`${root}/source.json`)) throw new Error("source promotion failed");
